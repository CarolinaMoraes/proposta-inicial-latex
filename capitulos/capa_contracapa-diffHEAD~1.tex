...
\local{São Paulo\par}
\data{2021}
%DIF <  \orientador{Lauro César Araujo}
%DIF <  \coorientador{Equipe \abnTeX}
\instituicao{%
...
%DIF <  O preambulo deve conter o tipo do trabalho, o objetivo,
%DIF <  o nome da instituição e a área de concentração
